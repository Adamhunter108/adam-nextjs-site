                    ...
                    <div className="mt-12 lg:mx-52 md:mx-36 lg:max-w-none">
                        ...
                        <motion.div className="flex flex-col rounded-xl shadow-lg overflow-hidden" initial="hidden" animate="visible" variants={{
                            ...
                            <form
                                ...
                                />
                                {errors?.email && (
                                    <p className="text-red-500">I need somewhere to hit you back</p>
                                )}
                                ...
                                <div className="flex flex-row items-center justify-center">
                                    <button
                                        type="submit" 
                                        className="px-10 mt-8 py-2 bg-gradient-to-b from-indigo-800 via-indigo-600 to-indigo-400 text-gray-50 hover:bg-gradient-to-t from-indigo-800 via-indigo-600 to-indigo-400 hover:text-gray-50 font-light rounded-md text-lg flex flex-row items-center"
                                        >
                                        {buttonText}
