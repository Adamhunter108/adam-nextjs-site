          ...
          <Link href="/blog" legacyBehavior>
            <a>
              <button className="lg:fixed lg:z-50 relative inline-flex h-12 overflow-hidden rounded-full p-[3px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
                ...
                <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-3 py-1 text-sm font-medium text-white hover:backdrop-blur-xl hover:text-black backdrop-blur-3xl">
                  <FontAwesomeIcon
                    style={{ fontSize: "25px" }}
                    icon={faBackward}
                  />{" "}
