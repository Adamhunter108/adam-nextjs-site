              ...
              <div className="flex-1 bg-white backdrop-blur-lg p-6 flex flex-col justify-between">
                <div className="flex-1">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    The front-end is a Next.js progressive web-app written in
                    TypeScript, styled with Tailwind CSS and deployed
                    continuously to Vercel via Git.
                  </p>
                  <p className="mt-2 text-base text-gray-500">
                    The back-end is built with Supabase, where a PostgreSQL
              ...
              <div className="flex-1 bg-white backdrop-blur-lg p-6 flex flex-col justify-between">
                <div className="flex-1">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    ...
                    CSS and features custom branding and graphics with an
              ...
              <div className="flex-1 bg-white backdrop-blur-lg p-6 flex flex-col justify-between">
                <div className="flex-1">
                  ...
                  {/* <p className="mt-2 text-base text-gray-500">
                    ...
                    and Single Sign-On (SSO) for Google accounts. While the app
                    is fully functional for users without accounts, those who
                    are not signed in will not be able to save their readings.
                  </p> */}
                  <p className="mt-2 text-base text-gray-500">
                    Please see the{" "}
                    <a
            ...
            >
              ...
              <div className="flex-1 bg-white backdrop-blur-lg p-6 flex flex-col justify-between">
                <div className="flex-1">
                  ...
                  <p className="mt-3 text-base text-gray-500">
                    A marketing and e-commerce website for The Ivy in Long
                    Beach, NY.
                  </p>
                  <p className="mt-3 text-base text-gray-500">
            ...
            >
              ...
              <div className="flex-1 bg-white backdrop-blur-lg p-6 flex flex-col justify-between">
                <div className="flex-1">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    The back-end is written in Python and features Django and
                    the Django REST framework to serve a custom built API. The
                    front-end features React with Bootstrap for UI styling and
                    Redux for state management. The live demo is using a
                    PostgreSQL database hosted on AWS. The images are stored in
                    AWS S3 buckets, the project is deployed via Heroku and
                    PayPal is set to developer sandbox for testing.
                  </p>
                </div>
                <div className="pt-2 flex">
                  {/* PYTHON SVG */}
