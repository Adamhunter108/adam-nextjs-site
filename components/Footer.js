...
const socials = [
    {
        name: 'GitHub',
        href: 'https://github.com/Adamhunter108/',
        icon: (props) => (
    ...
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/in/adamhhecht/',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
                fillRule="evenodd"
    ...
    {
      name: 'Email',
      href: "mailto:adamhunter928@gmail.com?subject= &body=Let's work on something cool together!",
      icon: (props) => (
      ...
      <footer className="bg-black">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
          <div className="flex justify-center space-x-6 md:order-2">
            {socials.map((item) => (
              <a key={item.name} href={item.href} target="_blank" className="text-gray-400 hover:text-indigo-400">
