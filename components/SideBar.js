  ...
  return (
    <>
        {showSidebar ? (
            ...
            >
                <FontAwesomeIcon className="text-indigo-500" style={{fontSize:"35px"}} icon={faXmark} /> 
            </button>
        ) : (
            // <svg
            // onClick={() => setShowSidebar(!showSidebar)}
        ...
        >
            <h3 className="mt-10 pb-5 text-4xl font-semibold text-white flex justify-center">
            Adam Hunter
            </h3>
