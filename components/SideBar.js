  ...
  return (
    <>
      {showSidebar ? (
        ...
        <button
          onClick={() => setShowSidebar(!showSidebar)}
          className="fixed z-30 flex items-center cursor-pointer right-4 lg:right-20 top-6"
        >
          <FontAwesomeIcon
            className="text-indigo-500 hover:text-white"
            style={{ fontSize: "35px" }}
      ...
      >
        ...
        <Link href="/">
          <div className="w-40">
            ...
            >
              <FontAwesomeIcon style={{ fontSize: "25px" }} icon={faHouse} />{" "}
              Home
            </button>
          </div>
        </Link>
        ...
        <Link href="/contact">
          <button
            ...
            className="text-gray-300 hover:bg-gray-700/40 hover:text-indigo-500 block px-3 py-4 rounded-md text-base font-medium"
          >
            <FontAwesomeIcon style={{ fontSize: "25px" }} icon={faPaperPlane} />{" "}
            Contact
          </button>
        </Link>
        ...
        <div className="absolute bottom-4 w-full flex justify-center">
          <p className="text-sm text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-lime-400 to-teal-400">
            Made with{" "}
            <FontAwesomeIcon
